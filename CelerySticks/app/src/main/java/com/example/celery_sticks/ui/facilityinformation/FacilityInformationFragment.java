...
public class FacilityInformationFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        FacilityInformationViewModel facilityInformationViewModel =
                new ViewModelProvider(this).get(FacilityInformationViewModel.class);

        binding = FragmentFacilityInformationBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textFacilityInformation;
        facilityInformationViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        return root;
    }
